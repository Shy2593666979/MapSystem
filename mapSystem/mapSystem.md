...
![在这里插入图片描述](https://img-blog.csdnimg.cn/8588919f94594b0ca1c2756aaacc4502.png)
### 技术栈选择
**用哈希map以及设置类进行数据的存储**
...
**数据解析：** 使用QT中的xml解析库函数<QDomStreamReader>进行数据的解析。读取其中的数据挑选出其中的ID 号，Lat维度，Lon经度。
### 算法实现
**真实经纬度坐标结构体类型**
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/20332d391e174c80912b5f50c75a0865.png)

 **经纬度坐标转换函数**
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/4e87652ddf40457a8749601527456cd1.png)

**构造解析OSM(XMl)类**
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/b8107297c373497fa875a81ae43a7148.png)

**数据类型转化**
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/bc5d0158537a4a24bbeed4fa0c4642ec.png)
根据经纬度计算点与点之间距离
![在这里插入图片描述](https://img-blog.csdnimg.cn/c5b7e18d1b134ecdb891a890192a93d7.png)
**画出道路图**
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/dc9ec09611b744e59b74d5df33d119b4.png)

**构造Floyd算法函数**
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/5421b08eb4fe458eac44b08e26e3adca.png)

### 界面实现

**在Widget标出村落**
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/2f1a81be3d554ea99bada751df199eb0.png)

**共54个村落标注点，接收起点终点，进行画线** 
![在这里插入图片描述](https://img-blog.csdnimg.cn/6b5293e8ea5e459598b01b1b1e13e54f.png)

**构造放大和缩小地图功能槽函数**
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/e6458b5d3a0e4bbbaed96e6bcc1260ef.png)
...
```
### 成果展示
![在这里插入图片描述](https://img-blog.csdnimg.cn/e641e8c00a314a3590f845942cf8e019.png)
### 源码下载 （免费）
**链接：** [https://pan.baidu.com/s/1Ai4m-X6GwLmkpbQpESRRDw](https://pan.baidu.com/s/1Ai4m-X6GwLmkpbQpESRRDw) 
**提取码：** 0703

-----
更多资料尽在 [GitHub](https://github.com/Shy2593666979) 欢迎各位读者去Star
